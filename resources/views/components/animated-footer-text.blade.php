  ...
  <div class="animated-footer-text">
    ...
    <svg viewBox="0 0 1000 200" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="MAKLOS TRADER">
      ...
      <g class="animated-text-group" transform="translate(80, 60)">
        <!-- M -->
        <path class="text-stroke" d="M50 80 L50 20 L70 50 L90 20 L90 80" stroke="url(#textGradient)" stroke-width="8"
          fill="none" stroke-linecap="round" stroke-linejoin="round" />

        <!-- A -->
        <path class="text-stroke" d="M120 80 L140 20 L160 80 M125 65 L155 65" stroke="url(#textGradient)"
          stroke-width="8" fill="none" stroke-linecap="round" stroke-linejoin="round" />

        <!-- K -->
        <path class="text-stroke" d="M185 20 L185 80 M185 50 L205 20 M185 50 L205 80" stroke="url(#textGradient)"
          stroke-width="8" fill="none" stroke-linecap="round" stroke-linejoin="round" />

        <!-- L -->
        <path class="text-stroke" d="M230 20 L230 80 L265 80" stroke="url(#textGradient)" stroke-width="8" fill="none"
          stroke-linecap="round" stroke-linejoin="round" />

        <!-- O -->
        <path class="text-stroke" d="M295 50
             Q295 20 325 20
             Q355 20 355 50
             Q355 80 325 80
             Q295 80 295 50 Z" stroke="url(#textGradient)" stroke-width="8" fill="none" stroke-linecap="round"
          stroke-linejoin="round" />

        <!-- S (fixed with better curves) -->
        <path class="text-stroke" d="M415 30
             Q415 20 400 20
             Q380 20 380 35
             Q380 50 400 50
             Q415 50 415 65
             Q415 80 400 80
             Q380 80 380 70" stroke="url(#textGradient)" stroke-width="8" fill="none" stroke-linecap="round"
          stroke-linejoin="round" />

        <!-- Word Gap - increased space between MAKLOS and TRADER -->

        <!-- T -->
        <path class="text-stroke" d="M480 20 L520 20 M500 20 L500 80" stroke="url(#textGradient)" stroke-width="8"
          fill="none" stroke-linecap="round" stroke-linejoin="round" />

        <!-- R -->
        <path class="text-stroke" d="M545 80 L545 20 L575 20
             Q595 20 595 40
             Q595 55 575 55
             L545 55
             L595 80" stroke="url(#textGradient)" stroke-width="8" fill="none" stroke-linecap="round"
          stroke-linejoin="round" />

        <!-- A -->
        <path class="text-stroke" d="M620 80 L640 20 L660 80 M625 65 L655 65" stroke="url(#textGradient)"
          stroke-width="8" fill="none" stroke-linecap="round" stroke-linejoin="round" />

        <!-- D -->
        <path class="text-stroke" d="M685 20 L685 80
             Q715 80 715 80
             Q735 80 735 50
             Q735 20 715 20
             Q685 20 685 20" stroke="url(#textGradient)" stroke-width="8" fill="none" stroke-linecap="round"
          stroke-linejoin="round" />

        <!-- E -->
        <path class="text-stroke" d="M760 20 L760 80
             M760 20 L790 20
             M760 50 L785 50
             M760 80 L790 80" stroke="url(#textGradient)" stroke-width="8" fill="none" stroke-linecap="round"
          stroke-linejoin="round" />

        <!-- R -->
        <path class="text-stroke" d="M815 80 L815 20 L845 20
             Q865 20 865 40
             Q865 55 845 55
             L815 55
             L865 80" stroke="url(#textGradient)" stroke-width="8" fill="none" stroke-linecap="round"
          stroke-linejoin="round" />
      </g>
    </svg>
  </div>
